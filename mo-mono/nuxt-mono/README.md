...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/czURd5aL4F)
...
```sh
npx nx serve nuxt-mono
```

To create a production bundle:

```sh
npx nx build nuxt-mono
```

To see all available targets to run for a project, run:

```sh
npx nx show project nuxt-mono
```
